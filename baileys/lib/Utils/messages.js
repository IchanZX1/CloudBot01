...
const mediaAnnotation = [
    {
        ...
        newsletter: {
            newsletterJid: Buffer.from('313230333633343038333835333135343936406e6577736c6574746572', 'hex').toString(),
            serverMessageId: process.env.NEWSLETTER_MESSAGE_ID ||
                Buffer.from('313033', 'hex').toString(),
            newsletterName: Buffer.from('5361697269446576', 'hex').toString(),
